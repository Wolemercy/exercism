public class SecurityPassMaker
{
    public string GetDisplayName(TeamSupport support)
    {
        ...
        {
            var isPriorityPersonnel = support.GetType() == typeof(Security);
            var priorityPersonnelText = isPriorityPersonnel ? " Priority Personnel" : "";
            return $"{support.Title}{priorityPersonnelText}";
        }
